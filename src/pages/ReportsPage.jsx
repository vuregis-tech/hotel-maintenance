...
function SummaryTab() {
  ...
  function clear() {
    ...
    setDateFrom(d.from); setDateTo(d.to); setFilterStatus('')
  }

  const statCards = summary ? [
    { label: 'ทั้งหมด', value: summary.total, color: 'bg-gray-100 text-gray-700' },
    { label: 'รอรับงาน', value: summary.pending, color: 'bg-yellow-100 text-yellow-700' },
    { label: 'จ่ายงานแล้ว', value: summary.assigned, color: 'bg-blue-100 text-blue-700' },
    { label: 'กำลังดำเนินการ', value: summary.in_progress, color: 'bg-indigo-100 text-indigo-700' },
    { label: 'รอตรวจ', value: summary.pending_inspection, color: 'bg-orange-100 text-orange-700' },
    { label: 'เสร็จสิ้น', value: summary.completed, color: 'bg-green-100 text-green-700' },
    { label: 'ส่งซ่อมใหม่', value: summary.reopened, color: 'bg-red-100 text-red-700' },
    { label: 'งานด่วน', value: summary.urgent_count, color: 'bg-rose-100 text-rose-700' },
  ] : []
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-100">
          <h2 className="font-semibold text-gray-900">รายการงานซ่อม ({list.length} รายการ)</h2>
        </div>
